...
tab1, tab2, tab3 = st.tabs(['야간 이미지 전처리' , '가로등 위치 데이터', '비추다 솔루션'])
...
with col3 : 
    ...
    st.sidebar.image(image_url, width=65, caption=None)
with col4 :
...
with tab1:
  ...
  image_url ="https://blogger.googleusercontent.com/img/a/AVvXsEj7nn_XYZV-E_L2QrSN7xwtGvWBQbt3qY0WDI01aplnHQW71xdAPcYSxLy1MGo6w6NVwLNDvRZMiN33ki7wEeiR28hhIIzjaIoSLYdpLxcW5VDjMe01mHeNlAnnlqPMbWLD5BwdzRLGGYlGoARy27OjRr6hCji7SJQYXYlesj6ZQI89FvfxU2Ez_G9js3g"
  st.image(image_url, width=250, caption=None)
...
with tab2:
  ...
  st.image(image_url, width=250, caption=None)
  image_url = "https://blogger.googleusercontent.com/img/a/AVvXsEgofr72ufMzfkGEpMJhKzv-r8-tKGRBzkKLQxqmqVxOrggR7I48hm4RZQEPHkMSXvNpmjsF9lZ9rHLwFKfeQVXk3vDHo1SifZut329-8V0lHM-PeUCTmljxTp2oG_2821NUEXRZvou_eS-fSNzbtNpS9hGWP6eNITCWVmBxd6_hTPycXGEFT0TiOBocVAY"
  st.image(image_url, width=250, caption=None)    
